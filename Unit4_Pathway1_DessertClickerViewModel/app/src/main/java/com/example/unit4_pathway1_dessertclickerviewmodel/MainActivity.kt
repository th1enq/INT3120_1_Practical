...
import com.example.unit4_pathway1_dessertclickerviewmodel.ui.theme.Unit4_Pathway1_DessertClickerViewModelTheme
...
class MainActivity : ComponentActivity() {
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            Unit4_Pathway1_DessertClickerViewModelTheme {
                Surface(
                    modifier = Modifier
                        .fillMaxSize()
                        .statusBarsPadding(),
...
private fun DessertClickerApp(
    ...
    Scaffold(
        topBar = {
            AppTopBar(
                onShareClicked = { context ->
                    shareGameProgress(
                        context, 
                        dessertClickerViewModel.dessertsSold, 
                        dessertClickerViewModel.revenue
                    )
                }
            )
        }
        ...
        DessertClickerScreen(
            revenue = dessertClickerViewModel.revenue,
            dessertsSold = dessertClickerViewModel.dessertsSold,
            dessertImageId = dessertClickerViewModel.currentDessert.imageId,
